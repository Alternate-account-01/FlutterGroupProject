              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 20),
                    _buildTextField(controller.descController, "Description", "Add a detailed description...", maxLines: 3),
                    const SizedBox(height: 20),
          ...
          child: ElevatedButton(
            onPressed: () {
              switch (selectedPriority.value) {
                case "Medium Priority": controller.categoryController.text = "Sekolah"; break;
                case "High Priority": controller.categoryController.text = "Pekerjaan"; break;
                default: controller.categoryController.text = "Pribadi"; break;
              }
              controller.saveTodo();
            },
